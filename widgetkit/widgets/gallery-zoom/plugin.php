...
return array(
    ...
    'config' => array(
        ...
        'label' => 'Gallery Zoom',
        'core'  => false,
        'icon'  => 'plugins/widgets/gallery-zoom/widget.svg',
        'view'  => 'plugins/widgets/gallery-zoom/views/widget.php',
    ...
    'events' => array(
        ...
        'init.site' => function($event, $app) {
            ...
            $app['scripts']->add('elevateZoom', 'wp-content/themes/yoo_master2_wp/widgetkit/widgets/gallery-zoom/elevatezoom-master/jquery.elevatezoom.js');
        },

        'init.admin' => function($event, $app) {
            $app['angular']->addTemplate('gallery-zoom.edit', 'plugins/widgets/gallery-zoom/views/edit.php', true);
        }
